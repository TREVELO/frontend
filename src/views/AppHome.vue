  ...
  <div class="home">
    ...
    <div>
      <button
        ...
        v-if="isPositionAccesable === false"
      ...
      <div v-else>
        <div style="margin-top: 50px">
          <b style="color: blue; font-size: 30px; vertical-align: middle"
            >추천 관광지</b
          ><button
            class="btn btn-info"
            style="margin-left: 10px; border: none"
            @click="makeRandom(nearAttractions, showAttractions)"
          >
            새로 고침
          </button>
        </div>
        <div style="margin-top: 50px">
          <div
            ...
            style="
              ...
              border-radius: 24px;
            "
            v-for="(show, index) in showAttractions"
            :key="show.contentId"
          >
            <img
              :src="show.first_image"
              class=""
              alt=""
              style="
                margin-top: 30px;
            ...
            <div class="card-body" style="height: ">
              ...
              <button
                ...
                @click="showDetail(showAttractions, index)"
              >
                상세 보기
              </button>
            </div>
        ...
        <div style="margin-top: 50px">
          ...
          ><button
            class="btn btn-info"
            style="margin-left: 10px; border: none"
            @click="makeRandom(nearShopping, showShopping)"
          >
            새로 고침
          </button>
        </div>
        <div style="margin-top: 50px">
          <div
            ...
            style="
              ...
              border-radius: 24px;
            "
            v-for="(show, index) in showShopping"
            :key="show.contentId"
          >
            <img
              :src="show.first_image"
            ...
            <div class="card-body" style="height: ">
              ...
              <button
                class="btn btn-outline-dark"
                @click="showDetail(showShopping, index)"
              >
                상세 보기
              </button>
            </div>
        ...
        <div style="margin-top: 50px">
          ...
          ><button
            class="btn btn-info"
            style="margin-left: 10px; border: none; vertical-align: middle"
            @click="makeRandom(nearRestaurant, showRestaurant)"
          >
            새로 고침
          </button>
        </div>
        <div style="margin-top: 50px">
          <div
            ...
            style="
              ...
              border-radius: 24px;
            "
            v-for="(show, index) in showRestaurant"
            :key="show.contentId"
          >
            <img
              @click="isModal = true"
            ...
            <div class="card-body" style="height: ">
              ...
              <button
                class="btn btn-outline-dark"
                @click="showDetail(showRestaurant, index)"
              >
                상세 보기
              </button>
            </div>
...
export default {
  ...
  methods: {
    ...
    getPositionValue(val) {
      ...
      axiosInstance
        .post(
          "http://localhost/api/v1/attraction/search?title=&sidoCode=&gugunCode=&contentType="
        )
        .then((res) => {
              ...
              if (nowAttraction.contentType == 12) {
                if (
                  this.getDistance(
                    ...
                    nowAttraction.latitude,
                    nowAttraction.longitude
                  ) < 20
                ) {
