          ...
          <div class="modal-body">
            <slot name="body">
              <div class="form-group">
                ...
                />
                <img
                  src="https://williesweeneewagon.com/wp-content/plugins/clover-online-orders/public/img/noImg.png"
                  alt=""
                  v-else
                  style="border-radius: 24px"
                />
...
export default {
  ...
  methods: {
    ...
    cancelRegisterAttraction() {
      ...
      axiosInstance
        .post(
          `http://localhost/api/v1/attraction/favorite/delete/${this.attraction.contentId}`
        )
        .then(() => {
          this.isLiked = false;
          alert("관심지 해제 성공");
